...
import numpy
from hook_features import unet_structure
from hook_features.unet_structure import UNet
...
from unet import get_unet_parameters , unet_structure
from unet.unet_structure import UNet
...
def train(train_loader_1, train_loader_2, model, criterion, optimizer, epoch, args, device):
    ...
    progress = ProgressMeter(
        len(train_loader_1) + len(train_loader_2),
